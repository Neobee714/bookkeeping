...
- [x] 发布 2.0.2 上线 ✅ 2026-08-16 16:40（versionCode 202;经 SOCKS5 代理 127.0.0.1:10808 发布成功;info.json/latest.apk 验证通过;GitHub 推送 4f8059b..a00e19b）
- [ ] 真机视觉确认（挖孔区域无白色、渐变铺满顶部）——用户手机 OTA 升级 2.0.2 后确认
